...
export default function AboutSection() {
    ...
    const heading = (
        <motion.h2
            ...
            className="text-[clamp(2rem,4vw,4rem)] font-black uppercase font-heading leading-[1.05]"
        >
    ...
    const body = (
        <motion.div
            ...
            className="space-y-4 text-foreground/75 leading-relaxed text-base max-w-md"
        >
            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-2 gap-16 items-start">
                    ...
                    <div className="space-y-8 pt-2">
                        <p className="text-lg text-foreground/70 leading-relaxed max-w-xs">
