...
export default function ContactSection() {
    ...
    return (
        <section id="contact" className="w-full px-12 py-24">
            ...
            <motion.footer
                ...
                className="mt-20 pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8"
            >
                <div>
