...
export default function HeroSection() {
    ...
    return (
        <section ref={containerRef} className="relative min-h-screen overflow-hidden flex flex-col justify-center px-6 pt-24 pb-12">
            ...
            <motion.div variants={anim.container} initial="hidden" animate="show" className="relative z-10 flex flex-col gap-6 max-w-sm mx-auto w-full text-center">
                ...
                <h1 className="text-[clamp(2.8rem,13vw,4.5rem)] leading-[0.95] font-black uppercase font-heading">
                ...
                <motion.p variants={anim.item} className="text-sm text-foreground/60 leading-relaxed">Design, marketing & technology — for brands that scale.</motion.p>
