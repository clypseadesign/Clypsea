                            ...
                            >
                                ...
                                <div className="flex items-start justify-between gap-4 pb-4">
                                    <div>
                                        ...
                                        <p className="text-xs text-accent uppercase tracking-[0.2em] font-bold mt-1">{project.category}</p>
                                    </div>
                                    <p className="text-sm text-foreground/50 max-w-[200px] text-right leading-relaxed">{project.desc}</p>
                                </div>
                            </div>
                        ))}
                    </motion.div>
